...
public:
    ...
    virtual void ConnectDc();

    virtual void Disconnect();

    virtual void ForceCampedOnEnb(uint16_t cellId, uint16_t dlEarfcn);

    virtual void ForceCampedOnSenb(uint16_t cellId, uint16_t dlEarfcn);
...
public:
    ...
    virtual uint8_t ActivateEpsBearerDc(ns3::Ptr< ns3::NetDevice > ueLteDevice, uint64_t imsi, ns3::Ptr< ns3::EpcTft > tft, ns3::EpsBearer bearer);

    virtual void AddEnb(ns3::Ptr< ns3::Node > enbNode, ns3::Ptr< ns3::NetDevice > lteEnbNetDevice, uint16_t cellId);

    virtual void AddSenb(ns3::Ptr< ns3::Node > enbNode, ns3::Ptr< ns3::NetDevice > lteEnbNetDevice, uint16_t cellId);
